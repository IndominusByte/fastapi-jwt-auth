...
async def login(user: User, Authorize: AuthJWT = Depends()):
    ...
    access_token = await Authorize.create_access_token(subject=user.username, algorithm="HS384")
    refresh_token = await Authorize.create_refresh_token(subject=user.username, algorithm="HS512")
